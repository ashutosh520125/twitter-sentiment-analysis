...
class SentimentAnalysis:
    ...
    def DownloadData(self):
        # authenticating
        consumerKey = 'RkiZcE4HYXQTZJCha6doNPAqM'
        consumerSecret = 'UOA7RJupMdbEE7ju7mvpexbAOaYxsCn0kzZAxHJt1kl0N5kXlL'
        accessToken = '1003524344310521858-xsRVLJuO805UiwTOceWw6t4MoZNMq3'
        accessTokenSecret = 'wHucOgxSRTlxOKnoZkxSPko1YQqAVR9FoLCIPg28Vf4XN'
    ...
    def plotPieChart(self, positive, wpositive, spositive, negative, wnegative, snegative, neutral, searchTerm, noOfSearchTerms):
        ...
        patches, texts = plt.pie(sizes, colors=colors, startangle=90) # pylint: disable=unused-variable
